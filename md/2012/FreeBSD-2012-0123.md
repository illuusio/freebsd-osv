...
## References
 ...
 - ADVISORY: [https://api.osv.dev/v1/vulns/CVE-2012-2806](https://api.osv.dev/v1/vulns/CVE-2012-2806)
 - WEB: [http://sourceforge.net/projects/libjpeg-turbo/files/1.2.1/README.txt](http://sourceforge.net/projects/libjpeg-turbo/files/1.2.1/README.txt)
 - REPORT: [https://bugzilla.redhat.com/show_bug.cgi?id=826849](https://bugzilla.redhat.com/show_bug.cgi?id=826849)
