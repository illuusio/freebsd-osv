...
## References
 ...
 - ADVISORY: [https://api.osv.dev/v1/vulns/CVE-2012-0809](https://api.osv.dev/v1/vulns/CVE-2012-0809)
 - WEB: [http://www.gratisoft.us/sudo/alerts/sudo_debug.html](http://www.gratisoft.us/sudo/alerts/sudo_debug.html)
