...
## References
 ...
 - ADVISORY: [https://api.osv.dev/v1/vulns/CVE-2015-5166](https://api.osv.dev/v1/vulns/CVE-2015-5166)
 - WEB: [http://xenbits.xen.org/xsa/advisory-139.html](http://xenbits.xen.org/xsa/advisory-139.html)
