...
## References
 ...
 - ADVISORY: [https://api.osv.dev/v1/vulns/CVE-2015-2756](https://api.osv.dev/v1/vulns/CVE-2015-2756)
 - WEB: [http://xenbits.xen.org/xsa/advisory-126.html](http://xenbits.xen.org/xsa/advisory-126.html)
