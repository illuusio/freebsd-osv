...
## References
 ...
 - ADVISORY: [https://api.osv.dev/v1/vulns/CVE-2015-8341](https://api.osv.dev/v1/vulns/CVE-2015-8341)
 - REPORT: [https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=205841](https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=205841)
 - WEB: [http://xenbits.xen.org/xsa/advisory-160.html](http://xenbits.xen.org/xsa/advisory-160.html)
