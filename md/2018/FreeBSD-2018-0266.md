...
## References
 ...
 - WEB: [http://nginx.org/en/security_advisories.html](http://nginx.org/en/security_advisories.html)
 - ADVISORY: [https://api.osv.dev/v1/vulns/CVE-2018-16843](https://api.osv.dev/v1/vulns/CVE-2018-16843)
 - ADVISORY: [https://api.osv.dev/v1/vulns/CVE-2018-16844](https://api.osv.dev/v1/vulns/CVE-2018-16844)
 - ADVISORY: [https://api.osv.dev/v1/vulns/CVE-2018-16845](https://api.osv.dev/v1/vulns/CVE-2018-16845)
