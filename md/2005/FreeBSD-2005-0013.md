...
## References
 ...
 - ADVISORY: [https://api.osv.dev/v1/vulns/CVE-2004-1138](https://api.osv.dev/v1/vulns/CVE-2004-1138)
 - WEB: [ftp://ftp.vim.org/pub/vim/patches/6.3/6.3.045](ftp://ftp.vim.org/pub/vim/patches/6.3/6.3.045)
