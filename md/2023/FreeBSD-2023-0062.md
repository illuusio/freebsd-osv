...
>   in a situation where the current working directory has contents that
...
>   function, the parameter file and parameter srcdir come from external
>   input, and parameters are not escaped. If a file name or directory
>   name contains shell metacharacters, code may be executed.
...
## References
 ...
 - ADVISORY: [https://cveawg.mitre.org/api/cve/CVE-2022-48337](https://cveawg.mitre.org/api/cve/CVE-2022-48337)
 - ADVISORY: [https://cveawg.mitre.org/api/cve/CVE-2022-48338](https://cveawg.mitre.org/api/cve/CVE-2022-48338)
 - ADVISORY: [https://cveawg.mitre.org/api/cve/CVE-2022-48339](https://cveawg.mitre.org/api/cve/CVE-2022-48339)
