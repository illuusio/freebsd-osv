...
\"uid=1001\>uid=1002\" can be abused to set the primary group ID to 0
even if the process did not originally belong to group 0.
...
ruleset such as the following could be exploited by a process running as
user 1001 and with an empty supplementary group list:
...
## Details
 ...
 - **vid**: [55fbe7b1-a0fe-11f1-ae1f-bc241121aa0a](https://vuxml.freebsd.org/freebsd/55fbe7b1-a0fe-11f1-ae1f-bc241121aa0a.html)

## References
 - ADVISORY: [https://cveawg.mitre.org/api/cve/CVE-2026-58092](https://cveawg.mitre.org/api/cve/CVE-2026-58092)
 - ADVISORY: [https://www.freebsd.org/security/advisories/FreeBSD-SA-26:59.mac_do.asc](https://www.freebsd.org/security/advisories/FreeBSD-SA-26:59.mac_do.asc)
